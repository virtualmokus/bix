  ...
  legal: {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          'Kizárólag szervezeti szintű információt gyűjtünk: cégneveket, autonóm rendszerszámokat, csatlakozási pontokat, kapacitásokat és peering-irányelveket. A kapcsolattartók nevét, e-mail-címét és telefonszámát szándékosan kihagyjuk, akkor is, ha a forrásnál nyilvánosan szerepel. Ez az oldal nem használ sütiket, nem futtat analitikát, és nem követi a látogatókat. A térképcsempék az OpenStreetMap szervereiről érkeznek, amelyek — mint minden hétköznapi webkérésnél — megkapják a látogató IP-címét.',
      },
      {
